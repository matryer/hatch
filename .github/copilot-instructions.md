...
_Review an open pull request for correctness, style, and tests._
...
_Authoring rules, skills, commands, and sub-agents for this project via hatch — write once, generate for every coding agent._
...
use `GitHub Copilot` and `copilot` — these are substituted at generation time
