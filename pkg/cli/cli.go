...
Flags:
  ...
  -banner            prepend a "generated by hatch — do not edit" banner to file-owned outputs
...
func commonFlags(name string, stderr io.Writer) *commonFlagSet {
	...
	return &commonFlagSet{
		...
		banner:       fs.Bool("banner", false, "prepend a 'generated by hatch — do not edit' banner to file-owned outputs"),
	}
}
